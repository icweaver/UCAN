...
md"""
Username is [AAVSO API key](https://targettool.aavso.org/TargetTool/api/index)
"""
...
if !isempty(username)
	r = let
		passwd = "api_token"
		api = "targettool.aavso.org/TargetTool/api/v1/telescope"
...
manifest_format = "2.0"
project_hash = "d4050fad44a7315e5cb60d7fc51f947063d5cbb1"
