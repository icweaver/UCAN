...
using PlutoUI, CCDReduction, DataFramesMeta, AstroImages
...
df_headers = fitscollection("./data/TRANSIT"; abspath=false)

# ╔═╡ 06d26240-81b6-401b-8eda-eab3a9a0fb20
md"""
We have $(nrow(df_headers)) with the following header keys:
"""

# ╔═╡ 8a78029c-ddf5-4ada-b6d3-a9a649bdbae8
df_headers |> names |> print
...
manifest_format = "2.0"
project_hash = "7f216f76ed2a056890270b7a255bf129afeeeac9"
