...
# ╔═╡ 3665c8de-c732-47e4-a847-52b312e41512
...
begin
	hdul_sci = fits.open("data/TRANSIT/ut20240325/sci/mgcc3f_2024-03-25T05-36-57.945_TRANSIT.fits")

	hdul_dark = fits.open("data/TRANSIT/ut20240325/dark/mgcc3f_2024-03-25T07-10-03.022_DARKFRAMEMEAN.fits")
...
# ╔═╡ 8bf469f7-5c6b-40d0-abbe-abe37d76a16c
data = sci - dark

# ╔═╡ 54fbecb9-31d9-468c-8994-402aeae8e02b
img_jl = PyMatrix(data) |> permutedims

# ╔═╡ 00e716cb-e036-4bd8-a459-b3943eab96fe
implot(img_jl; clims=(150, 700), colormap=:cividis)
...
CondaPkg.add("photutils"); CondaPkg.resolve()
...
manifest_format = "2.0"
project_hash = "290401c8e5eda5f9664b5e6b668d9585059f409b"
