...
# ╔═╡ daddf849-7861-4aec-ae0b-bd87519368ed
using PlutoUI, ImageShow, AstroImages

# ╔═╡ 69e00148-7a98-49f3-a78e-80c223184f9f
md"""
Linkies
...
# ╔═╡ 655e846d-c79b-47c3-9a5d-d38a35b50be7
img = load("./data/eVscope2-20250415-203258_sun.png")

# ╔═╡ bc789412-bdd2-44ba-ba5b-789477c07397
nrows, ncols = size(img)

# ╔═╡ 60880d93-9471-45b5-a6b7-276bfde18333
@bind x RangeSlider(1:ncols)

# ╔═╡ 5076b4d4-8c9e-4807-a11a-719d0c22a94b
@bind y RangeSlider(1:nrows)

# ╔═╡ 36b67665-4f20-4587-9a26-623ff10ad1b0
img[y, x]

# ╔═╡ 341194c3-6cfe-4c9b-98b9-127986e31239
size(img)

# ╔═╡ b7566b66-18b8-48a3-9e88-7fde5f82990c
@bind step Slider(1:50; show_value=true)

# ╔═╡ 7810d640-96fe-42fb-bfe8-e6b47e306e66
yee = img[begin:step:end, begin:step:end]
...
manifest_format = "2.0"
project_hash = "23c39c51092359a19d807587e912fa9a24d6c0de"
