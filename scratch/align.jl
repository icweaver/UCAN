...
# ╔═╡ c0ef8228-3f60-11ef-256d-3184a42fa1e3
begin
	using AstroImages, PythonCall, CondaPkg, PlutoUI

	CondaPkg.add_pip("astroalign")
	CondaPkg.add("numpy"; version="<2")
end

# ╔═╡ c74ea225-c49e-417c-b8e8-af5b9229aab5
CondaPkg.status()
...
manifest_format = "2.0"
project_hash = "6e64227ed4fb87c074c8461b5a9436f098541477"
